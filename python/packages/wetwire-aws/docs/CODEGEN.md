...
```jinja
{# templates/resource.py.j2 #}
"""
{{ service_name }} {{ resource.name }} resource.
...
{% for enum in enums %}
from .enums import {{ enum.name }}
{% endfor %}


@wetwire
@dataclass
class {{ resource.name }}(CloudFormationResource):
    """{{ resource.documentation }}"""

    _resource_type: ClassVar[str] = "{{ resource.full_type }}"
...
Generated:
  Source: CloudFormation Spec 208.0.0
  Generator: 1.0.0
  Date: 2024-12-26T20:30:00Z
