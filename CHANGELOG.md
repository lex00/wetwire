...
- CloudFormation spec version now extracted from `Last-Modified` HTTP header (YYYY.MM.DD format) instead of `ResourceSpecificationVersion` JSON field
...
[unreleased]: https://github.com/lex00/wetwire/compare/v0.1.4...HEAD
[0.1.4]: https://github.com/lex00/wetwire/compare/v0.1.3...v0.1.4
