...
CloudFormation infrastructure as Go code, generated by [wetwire-aws](https://github.com/lex00/wetwire-aws).
...
Import from `+"`github.com/lex00/wetwire-aws/intrinsics`"+`:
