...
Wetwire is split across multiple repositories:

| Repository | Language | Purpose | PyPI / Go Modules |
|------------|----------|---------|-------------------|
| [wetwire-core-python](https://github.com/lex00/wetwire-core-python) | Python | Core library (personas, scoring, agents) | `wetwire-core` |
| [wetwire-aws-python](https://github.com/lex00/wetwire-aws-python) | Python | AWS CloudFormation synthesis | `wetwire-aws` |
| [wetwire-core-go](https://github.com/lex00/wetwire-core-go) | Go | Core library (personas, scoring, agents) | `github.com/lex00/wetwire-core-go` |
| [wetwire-aws-go](https://github.com/lex00/wetwire-aws-go) | Go | AWS CloudFormation synthesis + CLI | `github.com/lex00/wetwire-aws-go` |

This repository (wetwire) contains cross-language documentation:

```
wetwire/
├── docs/
│   ├── architecture/       # Architecture docs
│   └── research/           # Feasibility studies (GCP, Azure, K8s)
└── README.md               # Overview and links to repos
```
...
- [Go.md](../research/Go.md) — Go implementation details
- [AWS.md](../research/AWS.md) — AWS-specific patterns
