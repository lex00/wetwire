...
```
github.com/lex00/wetwire-aws-go    # AWS domain package (library + CLI)
github.com/lex00/wetwire-core-go   # Agent CLI tool (CLI only, not importable)
```

**Decision:** Module paths confirmed. Each package has its own repository.
...
```
wetwire-aws-go/               # github.com/lex00/wetwire-aws-go
├── go.mod
...
wetwire-core-go/              # github.com/lex00/wetwire-core-go
├── go.mod
├── internal/
