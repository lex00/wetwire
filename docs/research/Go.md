...
The Go implementation is split across two repositories:

| Repository | Purpose |
|------------|---------|
| [wetwire-core-go](https://github.com/lex00/wetwire-core-go) | AI agent orchestration (personas, scoring, results, orchestrator) |
| [wetwire-aws-go](https://github.com/lex00/wetwire-aws-go) | AWS CloudFormation synthesis library + CLI |
